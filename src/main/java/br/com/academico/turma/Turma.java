...
public class Turma implements Serializable {
    ...
    private List<Aluno> alunos = new ArrayList<Aluno>(); // Associação Estrutural - Agregação - Apartir de atributo
    private List<Sala> salas = new ArrayList<Sala>(); // Associação Estrutural - Agragação - Apartir de atributo
