...
public class CriarArquivo {
    ...
    // Gera saída de dados no arquivo
    ...
    public static void adicionarRegistro() {
        ...
        try {
            ...
            aluno.setSexo('F');
            aluno.setCpf("999");
            aluno.setEndereco(new Endereco(999L, "Rua", "Bairro", "Cidade", "Estado"));
            ...
            aluno2.setSexo('M');
            aluno2.setCpf("555");
            aluno2.setEndereco(new Endereco(555L, "RuaA", "BairroA", "CidadeA", "EstadoA"));
            ...
            aluno2.calcularMediaAritmetica();
